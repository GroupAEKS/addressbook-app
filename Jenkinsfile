pipeline {
    ...
    stages {
      ...
      steps {
          ...
          sh "sudo docker build -t addressbook:1.6.0 ."
          sh "sudo docker tag addressbook:1.6.0 public.ecr.aws/e4o4k3j4/addressbook:1.6.0"
          sh "sudo docker push public.ecr.aws/e4o4k3j4/addressbook:1.6.0"
      }
    }
